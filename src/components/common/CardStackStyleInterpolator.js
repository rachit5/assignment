...
//  const opacity = 1
  ...
  // const translateY = position.interpolate({
  //   inputRange,
  //   outputRange: [500, 0,0, -400],
  // });
  const translateY =0
  const translateX = position.interpolate({
    inputRange,
    outputRange: [-50, 0,-350, -350],
  });
  // const translateX = 0
  return {
    opacity,
...
function forFadeFromRight(props) {
  const { layout, position, scene } = props;
